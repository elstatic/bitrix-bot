"""Claude API клиент для суммаризации чатов (stdlib only)."""
...
class ClaudeClient:
    """Асинхронный клиент для Claude API (без внешних зависимостей)."""
...
- Отвечай ТОЛЬКО валидным JSON, без дополнительного текста"""
    ...
    async def summarize_dialog(
        ...
        try:
            ...
            data = await loop.run_in_executor(_executor, self._sync_post, payload)
