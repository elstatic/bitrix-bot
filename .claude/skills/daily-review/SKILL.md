---
name: daily-review
description: "Обзор дня: сводка по чатам, задачам и встречам из Битрикс24. Активируется при упоминании: обзор дня, дайджест, сводка дня, что нового, что произошло за день, daily review"
---
